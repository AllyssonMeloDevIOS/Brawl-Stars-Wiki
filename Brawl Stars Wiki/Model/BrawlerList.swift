...
//    
//    enum CodingKeys: String, CodingKey {
//        case name, rarity, iconBrawl
//        case brawlerClass = "class"
////        case descriptionBrawler = "description"
//
//    }
//}
// MARK: - BrawlerElement
struct BrawlerList: Codable {
    let id, name, description, rarity: String?
    let brawlerClass: String?
    let iconBrawl: String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case brawlerClass = "class"
        case iconBrawl, createdAt, updatedAt
    }
}

typealias Brawler = [BrawlerList]
